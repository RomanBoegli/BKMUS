...
# Load the file (change filename as needed)
file_path = "DataCollection.xlsx"  # or .ods
...
if all(len(g) >= 3 for g in [group_hw, group_sw, group_cu]):
    ...
    print(f"Shapiro-Wilk p-values: HW={sh_hw.pvalue:.3f}, SW={sh_sw.pvalue:.3f}, CU={sh_cu.pvalue:.3f}")
else:
